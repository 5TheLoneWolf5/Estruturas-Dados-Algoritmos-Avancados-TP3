bairros = {
    'Bairro A': [("Bairro B", 1), ("Bairro C", 4)],
    'Bairro B': [("Bairro A", 1), ("Bairro C", 2), ("Bairro D", 5)],
    'Bairro C': [("Bairro A", 4), ("Bairro B", 2), ("Bairro D", 1)],
    'Bairro D': [("Bairro B", 5), ("Bairro C", 1)],
}
...
dijkstra(bairros, 'Bairro A', 'Bairro D')